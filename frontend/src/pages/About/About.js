            ...
            <div className="w-full h-full bg-white py-20">
                ...
                <div className="mx-auto w-3/5">
                    <p className="text-black text-lg">
                        This is a real-time AI-based Yoga Trainer that evaluates how well you are performing your yoga poses. We, a team of 5 2nd year 2024 AI and Data Science students , created this as part of our college semester mini project. The project is deployed so that others can benefit from it.
