...
import { Card, CardBody, Image, Stack, Heading, Text, Divider, CardFooter, ButtonGroup, Button, Grid, GridItem } from '@chakra-ui/react';
                            ...
                            <Card maxW='sm'>
                                <CardBody>
                                    ...
                                    <Stack mt='6' spacing='2' className='px-12'>
                                        <Heading size='md' className='px-2'>{card.title}</Heading>
                                        <ButtonGroup spacing='2' justifyContent="space-between" className='py-1'>
                                            <Text fontSize='2xl' className='p-2'>
                                                {card.disp}
                                            </Text>
                                            <Button className='border p-2 hover:text-black' borderRadius='10' borderColor='#5DA145' color={'#5DA145'}>
                                                View Details
                                            </Button>
                                        </ButtonGroup>
                                    </Stack>
